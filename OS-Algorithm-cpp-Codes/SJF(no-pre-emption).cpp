//SJF scheduling algorithm without preemption:
...
int main() {
    ...
    while (completed_processes < n) {
        ...
        int process_wait_time = current_time - processes[shortest_job_index].arrival_time - processes[shortest_job_index].burst_time;
